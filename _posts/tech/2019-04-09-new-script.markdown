...
description: "Script to generate a new shell script"
...
> [new script](http://linuxcommand.org/lc3_new_script.php)

This script is used to generate the well-formatted shell script.
